<head>
    ...
    <title>Yardim - Website Development Team</title>
    <!-- Favicon-->
 ...
 */
        ...
        *::after {
        ...
        .btn-secondary.focus {
            ...
            background-color: #dc7633;
            border-color: #dc7633;
            box-shadow: 0 0 0 0.2rem rgba(220, 118, 51, 1);
        }
        ...
        .bg-danger {
            background-color: #d45c34 !important;
        }
        ...
        header.masthead {
            ...
            background: linear-gradient(to bottom, rgba(92, 77, 66, 0.8) 0%, rgba(92, 77, 66, 0.8) 100%), url("../img/default.jpg");
        ...
        #portfolio .container-xl .portfolio-box .portfolio-box-caption {
            ...
            opacity: 0;
            color: #fff;
            background: rgba(178, 59, 46, 0.81);
